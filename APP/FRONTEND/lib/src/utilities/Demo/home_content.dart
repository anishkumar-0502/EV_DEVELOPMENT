...
//     print(" fetchAllChargers $_radius");
...
//                     _isViewingCurrentLocation = true; // Update the flag
...
//       return const LinearGradient(
//         colors: [Colors.orange, Color.fromARGB(255, 198, 243, 33)],
//         stops: [0.0, 1.0],
//       );
//     } else {
//       // Gradient from blue to purple for higher radius
//       return const LinearGradient(
//         colors: [Color.fromARGB(255, 170, 243, 33), Colors.green],
//         stops: [0.0, 1.0],
//       );
//     }
//   }
...
//               ],
//             ),
// // Positioned widget for the toggle button
// Positioned(
//   top: screenHeight * 0.12, // Adjust dynamically based on screen height
//   right: screenWidth * 0.046, // Dynamically position based on width
//   child: Column(
//     children: [
//       GestureDetector(
//         onTap: () {
...
//           width: screenWidth * 0.07, // Smaller toggle button width
//           height: screenHeight * 0.07, // Smaller toggle button height
//           decoration: BoxDecoration(
//             color: Colors.black,
...
//                   : Icons.arrow_left,
//               color: Colors.white,
//               size: screenWidth * 0.05, // Smaller icon size
//             ),
//           ),
//         ),
//       ),
...
// // Positioned widget for the slider
// Positioned(
//   top: screenHeight * 0.140, // Adjust dynamically based on screen height
//   right: screenWidth * 0.14, // Reduced width for the slider
//   left: screenWidth * 0.05, // Add dynamic padding
...
//         Container(
//           height: screenHeight * 0.004, // Reduced height for the slider track
//           decoration: BoxDecoration(
...
//             trackHeight: screenHeight * 0.005, // Reduced track height
//             thumbShape: RoundSliderThumbShape(
//               enabledThumbRadius: screenWidth * 0.015, // Smaller thumb size
//             ),
//             overlayShape: RoundSliderOverlayShape(
//               overlayRadius: screenWidth * 0.03, // Smaller overlay size
//             ),
//             overlayColor: const Color.fromARGB(255, 62, 197, 87).withOpacity(0.2),
