...
void _searchChargerId(String chargerId) async {
  ...
  Future<List<Map<String, dynamic>>> fetchLocations(String query) async {
    const String apiKey =
        'AIzaSyCwyCo-jhRnxEo55neAZI8cCbVbdwLtmJ8'; // Replace with your actual API key
    final String apiUrl =
...
//   static const String apiKey = 'AIzaSyA3OKRtDl9fr9piSpHi2al4Xr-0qqAjWMU';
...
// //   // Batch request to fetch all addresses for the collected coordinates
// //   List<String> addresses = await _getBatchAddresses(coordinates);

// //   // Generate markers
// //   for (int i = 0; i < coordinates.length; i++) {
// //     LatLng position = coordinates[i];
// //     String fullAddress = addresses[i];
...
// // // Function to fetch all addresses in a single request
// // Future<List<String>> _getBatchAddresses(List<LatLng> coordinates) async {
// //   // Prepare coordinates in a format the API accepts
// //   String coordinateParams = coordinates
// //       .map((coord) => '${coord.latitude},${coord.longitude}')
// //       .join('|');

// //   // Example API URL (replace with your actual batch geocoding endpoint)
// //   String url =
// //       'https://maps.googleapis.com/maps/api/geocode/json?coordinates=$coordinateParams&key=AIzaSyA3OKRtDl9fr9piSpHi2al4Xr-0qqAjWMU';

// //   // Send request
// //   final response = await http.get(Uri.parse(url));

// //   if (response.statusCode == 200) {
// //     // Parse the response and extract addresses
// //     List<String> addresses = []; // Parse your API's specific response format
// //     return addresses;
// //   } else {
// //     throw Exception('Failed to fetch batch addresses');
// //   }
// // }
