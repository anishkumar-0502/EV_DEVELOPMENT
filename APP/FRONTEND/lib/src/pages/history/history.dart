...
void _showSessionDetailsModal(BuildContext context, Map<String, dynamic> sessionData) {
...
void _showsessionhelp() {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true, // Ensures the modal height can be dynamically adjusted
    isDismissible: true,
    enableDrag: true,
    builder: (BuildContext context) {
      return Padding(
        padding: MediaQuery.of(context).viewInsets, // Padding for the keyboard (if needed)
        ...
        children: <Widget>[
          ...
          isLoading
              ? Padding(
                  ...
                  child: _buildShimmerCard(context), // Display shimmer card while loading
                )
              : Row(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  ...
                                  style: const TextStyle(fontSize: 16, color: Colors.green), // The value in green
                                ),
                                const TextSpan(
                                  text: ' kWh',
                                    ...
                                    child: Column(
                                      children: [
                                        for (int index = 0; index < sessionDetails.length; index++)
                                          InkWell(
                                            onTap: () {
                                              _showSessionDetailsModal(context, sessionDetails[index]);
                                            },
                                            child: Column(
                                              children: [
                                                Padding(
