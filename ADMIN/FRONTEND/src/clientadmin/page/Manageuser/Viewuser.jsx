                                            ...
                                            <div className="col-md-12 grid-margin">
                                                <div className="row">
                                                    ...
                                                    <div className="row col-12 col-xl-12">
                                                        ...
                                                        <div className="col-md-4">
                                                            <div className="form-group row">
                                                                <div className="col-sm-12" style={{ fontWeight: 'bold' }}>Association Name: <span style={{fontWeight:'normal'}}>{newUser.association_name ? newUser.association_name : '-'}</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row col-12 col-xl-12">
